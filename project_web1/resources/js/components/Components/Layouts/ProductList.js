...
import MenuForProductList from '../MenuForProductList';
...
function ProductList(props) {
    ...
    const resultsPerPage = useRef(36);
    ...
    return (
        <>
            {/* Controls: */}
            <MenuForProductList categoryID={props.categoryID}></MenuForProductList>

            {/* List of products to be displayed: */}
            <div className="list-of-products">
                <div className="list-title">Danh sách: {props.title} ({props.products.length} kết quả)</div>
                                    ...
                                    return (
                                        <Col xs={12} sm={8} md={6} lg={6} xl={4} key={`product-item-${index}`} name={`product-item-${index}`}>
                                            <div className="product-quick-info">
                                                ...
                                                <div className="product-quick-info-rate">
                                                    <Rate disabled value={Math.round(parseFloat(product.rating_value))} />
                                                </div>
